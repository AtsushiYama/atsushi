...
DATE='2026-08-29'; VENUE=7; RNO=10
EX=[6.72,6.90,6.88,6.82,6.84,6.80]
WIND_SPEED=1.0; WAVE=0.0; WEATHER=3
...
def main():
 ...
 cards=read_csv(SRC/'data/programs/race_cards/2026/08/29.csv'); card=D(cards)[f'2026082907{RNO:02d}']
