...
code='202608312312'; venue=23; rno=12; card=cd[code]
tkz=pd.Series({'艇1_展示タイム':'6.78','艇2_展示タイム':'6.81','艇3_展示タイム':'6.86','艇4_展示タイム':'6.82','艇5_展示タイム':'6.84','艇6_展示タイム':'6.89'})
sui=pd.Series({'風速(m)':'4','波の高さ(cm)':'4','風向':'2','天候':'1'})
