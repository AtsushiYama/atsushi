...
label,code,venue,rno,exh,ws,wave,weather,actual_w=('TSU10','202608280910',9,10,[6.81,6.84,6.85,6.88,6.85,6.81],1.0,1.0,1,3)
perm=['-'.join(map(str,p)) for p in itertools.permutations(range(1,7),3)]
print('CASE',label,code,flush=True); card=cd[code]
...
chosen=results[0] if len(results)==1 else next(z for z in results if z[0].get('風向')==actual_w)
