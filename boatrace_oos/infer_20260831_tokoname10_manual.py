...
code='202608310810'; venue=8; rno=10; card=cd[code]
tkz=pd.Series({'艇1_展示タイム':'6.78','艇2_展示タイム':'6.81','艇3_展示タイム':'6.84','艇4_展示タイム':'6.74','艇5_展示タイム':'6.82','艇6_展示タイム':'6.81'})
sui=pd.Series({'風速(m)':'3','波の高さ(cm)':'1','風向':'1','天候':'1'})
