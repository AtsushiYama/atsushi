...
code='202608300708'; venue=7; rno=8
card=cd[code]
tkz=pd.Series({'艇1_展示タイム':'6.73','艇2_展示タイム':'6.72','艇3_展示タイム':'6.76','艇4_展示タイム':'6.76','艇5_展示タイム':'6.82','艇6_展示タイム':'6.76'})
sui=pd.Series({'風速(m)':'2','波の高さ(cm)':'1','風向':'5','天候':'1'})
