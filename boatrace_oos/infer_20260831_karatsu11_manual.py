...
code='202608312311'; venue=23; rno=11; card=cd[code]
tkz=pd.Series({'艇1_展示タイム':'6.77','艇2_展示タイム':'6.90','艇3_展示タイム':'6.81','艇4_展示タイム':'6.90','艇5_展示タイム':'6.87','艇6_展示タイム':'6.83'})
sui=pd.Series({'風速(m)':'4','波の高さ(cm)':'4','風向':'1','天候':'1'})
