...
code='202608300710'; venue=7; rno=10
card=cd[code]
tkz=pd.Series({'艇1_展示タイム':'6.71','艇2_展示タイム':'6.83','艇3_展示タイム':'6.84','艇4_展示タイム':'6.85','艇5_展示タイム':'6.82','艇6_展示タイム':'6.86'})
sui=pd.Series({'風速(m)':'1','波の高さ(cm)':'0','風向':'5','天候':'3'})
