...
def main():
    ...
    for dt in pd.date_range('2026-01-01','2026-06-30',freq='D'):
    ...
    for dt in pd.date_range('2026-07-01','2026-07-31',freq='D'):
    ...
    df.to_csv('audit_daily_20260701_0731_detail.csv',index=False); dd.to_csv('audit_daily_20260701_0731_summary.csv',index=False)
