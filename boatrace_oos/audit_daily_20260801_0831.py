...
def main():
    ...
    for dt in pd.date_range('2026-08-01','2026-09-11',freq='D'):
    ...
    df.to_csv('audit_daily_20260801_0911_detail.csv',index=False); dd.to_csv('audit_daily_20260801_0911_summary.csv',index=False)
