...
code='202608311605'; venue=16; rno=5; card=cd[code]
tkz=pd.Series({'艇1_展示タイム':'6.95','艇2_展示タイム':'6.88','艇3_展示タイム':'6.84','艇4_展示タイム':'6.89','艇5_展示タイム':'6.83','艇6_展示タイム':'6.82'})
sui=pd.Series({'風速(m)':'3','波の高さ(cm)':'3','風向':'4','天候':'1'})
