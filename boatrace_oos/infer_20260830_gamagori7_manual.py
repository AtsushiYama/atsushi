...
code='202608300707'; venue=7; rno=7
# User-provided official display screenshot at 17:40 JST.
tkz={f'艇{i}_展示タイム':v for i,v in enumerate([6.73,6.73,6.78,6.78,6.77,6.63],1)}
# Screenshot: sunny, wind 3m, wave 1cm, same left-arrow wind direction as prior Gamagori 6R (source direction code 6).
sui={'風速(m)':3.0,'波の高さ(cm)':1.0,'風向':6,'天候':1}
