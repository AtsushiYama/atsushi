...
code='202608280509'; card=cd[code]; exh=[6.70,6.80,6.85,6.78,6.80,6.85]
manual_tkz={f'艇{i}_展示タイム':v for i,v in enumerate(exh,1)}
print('CASE TAMAGAWA9',code,flush=True); print('PRESENT',code in cd,code in td,code in sd,code in od,flush=True)
...
for raw_sui in raw_sui_list:
 x,err=build_feature_frame(card,raw_tkz,raw_sui,state,5,9); assert err is None,err
