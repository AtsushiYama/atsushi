...
code='202608281111'; card=cd[code]; exh=[6.77,6.78,6.76,6.78,6.83,6.86]
manual_tkz={f'艇{i}_展示タイム':v for i,v in enumerate(exh,1)}
print('CASE BIWAKO11',code,flush=True); print('PRESENT',code in cd,code in td,code in sd,code in od,flush=True)
