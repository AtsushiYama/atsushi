...
code='202608280911'; card=cd[code]; exh=[6.85,6.88,6.94,6.83,6.82,6.93]
manual_tkz={f'艇{i}_展示タイム':v for i,v in enumerate(exh,1)}
print('CASE TSU11',code,flush=True); print('PRESENT',code in cd,code in td,code in sd,code in od,flush=True)
...
for raw_sui in raw_sui_list:
 x,err=build_feature_frame(card,raw_tkz,raw_sui,state,9,11); assert err is None,err
