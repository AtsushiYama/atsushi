...
code='202608310508'; venue=5; rno=8; card=cd[code]
tkz=pd.Series({'艇1_展示タイム':'6.75','艇2_展示タイム':'6.66','艇3_展示タイム':'6.65','艇4_展示タイム':'6.72','艇5_展示タイム':'6.78','艇6_展示タイム':'6.81'})
# screenshot: cloudy, wind 2m, wave 2cm, arrow right. Evaluate all raw wind-direction codes to guard mapping uncertainty.
for wc in range(1,9):
 sui=pd.Series({'風速(m)':'2','波の高さ(cm)':'2','風向':str(wc),'天候':'2'})
...
print('EXHIBIT 6.75|6.66|6.65|6.72|6.78|6.81',flush=True)
