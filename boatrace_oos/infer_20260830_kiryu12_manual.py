...
code='202608300112'; venue=1; rno=12; card=cd[code]
tkz=pd.Series({'艇1_展示タイム':'6.73','艇2_展示タイム':'6.92','艇3_展示タイム':'6.85','艇4_展示タイム':'6.74','艇5_展示タイム':'6.94','艇6_展示タイム':'6.80'})
...
if sui is None:
 sui=pd.Series({'風速(m)':'0','波の高さ(cm)':'0','風向':'0','天候':'2'})
